...
module V2
  class Unit < ApplicationRecord
    ...
    belongs_to :parent, class_name: "::V2::Unit", foreign_key: "parent_code", primary_key: "code", inverse_of: :children
    has_many :children, class_name: "::V2::Unit", foreign_key: "parent_code", primary_key: "code", inverse_of: :parent, dependent: :delete_all
    belongs_to :maintainer, class_name: "::User", foreign_key: "maintainer", primary_key: "email", inverse_of: :units
